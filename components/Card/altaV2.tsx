    ...
    return (
        <article
            ...
            className={cn(
                ...
                "max-w-none",
                "rounded-3xl border border-black/10 bg-white dark:bg-zinc-950 dark:border-white/20",
                "py-2 px-3",
                className
            )}>
            ...
            <div className="relative z-10 flex items-center gap-6">
                ...
                <div className="shrink-0">
                    <div
                        className={cn(
                            "relative overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-900/60",
                            isCompact ? "h-[150px] w-[150px]" : "h-[190px] w-[190px]"
                        )}
                    >
                        {imageUrl ? (
                            <Image
                ...
                {/* RIGHT: empty for now (actions later) */}

                <div className="shrink-0 flex flex-col items-end gap-3">
                    {/* shuffle */}
                    <button
                        type="button"
                        className="h-10 w-10 rounded-2xl bg-white/90 backdrop-blur border shadow-md
                    ...
                    {/* cart (bigger) */}
                    <Button
                        className="h-10 w-10 rounded-2xl shadow-md text-white flex items-center justify-center
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.boxShadow = `0 0 18px ${themeColor}CC`;
                        }}
                        onMouseLeave={(e) => {
                            e.currentTarget.style.boxShadow = "none";
                        }}
                    >
                        <ShoppingCart className={cn("h-5 w-5")} />
                    </Button>
                </div>
...
export const ProductCardAltaHorizontal = memo(ProductCardInner);
ProductCardAltaHorizontal.displayName = "ProductCard";