...
function ProductCardInner({
    ...
    const hoverImageUrl = resolveImageUrl(images[1] || "");
    ...
    return (
        <article
            ...
            className={cn(
                ...
                "bg-white border-black/10 dark:bg-zinc-950 dark:border-white/10",
                className
            )}
        >
            ...
            <CardContent className="p-0 relative">
                <div className="relative"
                    ...
                    <AspectRatio
                        className="overflow-hidden bg-zinc-100 dark:bg-zinc-900/60 relative"
                        ratio={1}
                    >
                        {imageUrl ? (
                            <Image
                        ...
                        {hoverImageUrl && (
                            <Image
                                ...
                                sizes={styles.imgSizes}
                                src={hoverImageUrl}
                                unoptimized={isS3Url(hoverImageUrl)}
                            />
                        )}
                    ...
                    {showActions && (
                        <div className="w-full flex items-stretch gap-2 pointer-events-auto">
                            <Button
                                className={cn(
                                    styles.addBtnHeight,
                                    "flex-1 rounded-md font-semibold shadow-md flex items-center justify-center gap-2 text-white transition-all",
                                    "hover:opacity-80"
                                )}
...
export const ProductCardV2 = memo(ProductCardInner);
ProductCardV2.displayName = "ProductCard";
