        ...
        <div className="relative">
          ...
          >
            ...
            <div className="absolute bottom-0 inset-x-0 z-20 pointer-events-none">
              ...
              {hasDiscount && (
                <div
                  className="absolute bottom-0 left-5 rounded-t-[10px] px-3 py-1.5"
                  style={{ backgroundColor: "rgba(0,0,0,0.5)" }}
                >
                  <span
                    className={cn(
                      styles.oldPriceSize,
                      "whitespace-nowrap line-through text-white/60",
                    )}
                  >
              ...
              {/* New price — right */}
              <div
                className="absolute bottom-0 right-3 rounded-t-[10px] px-3.5 py-2"
...
export const ProductCard2New = memo(ProductCardInner);
ProductCard2New.displayName = "ProductCard";
